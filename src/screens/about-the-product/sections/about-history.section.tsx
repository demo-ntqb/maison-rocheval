...
export async function AboutHistorySection() {
  ...
  return (
    <section data-plumb-id="frame-2085667065" aria-labelledby="sturgeon-journey-title" className="flex flex-col items-center justify-center bg-canvas py-24 lg:py-[200px]">
